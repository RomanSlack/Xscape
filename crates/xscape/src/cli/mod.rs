...
#[derive(Parser)]
#[command(name = "xscape")]
#[command(about = "Escape from Xcode. Build and run iOS apps from Linux.")]
#[command(version)]
#[command(propagate_version = true)]
pub struct Cli {
    /// Configuration file path
    #[arg(short, long, global = true, env = "XSCAPE_CONFIG")]
    pub config: Option<PathBuf>,

    /// Agent URL (overrides config)
    #[arg(long, global = true, env = "XSCAPE_AGENT_URL")]
